      ...
      try{
        ...
        var embeds = [
          ...
          new MessageEmbed()
            ...
            .setImage(message.guild.banner ? message.guild.bannerURL({size: 4096}) : "https://media.discordapp.net/attachments/935254407145218069/935258252030144573/i01_puppy-pembroke-welsh-corgi-stock-photography-nose-dog-removebg-preview.png")
